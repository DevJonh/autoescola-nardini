  ...
  return (
    <>
      <Hero image={bg}>
        ...
        <BreadCrumb
          items={[{ label: "Inicio", link: "/" }, { label: "Sobre" }]}
        />
      </Hero>
      <Section>
        <Grid md={2}>
          <div>
            ...
            <p>
              Sint veritatis magni minus. Quam, ducimus tempore. Aliquam odit
              qui earum neque. Corporis repellendus veniam assumenda officia,
              pariatur impedit eveniet, laudantium nemo minus eaque saepe
              voluptate maxime vitae atque hic.
            </p>
          ...
          <div>
            <p>
              ...
              Aspernatur fugit ipsam eveniet alias, doloribus iure quas dicta
              eaque temporibus, tempore praesentium laborum. Necessitatibus fuga
              nobis unde quae voluptates reprehenderit quidem.
            </p>
            <center>
              <ImageContainer>
                <AboutImage />
        ...
        <Grid md={2}>
          <div>
            ...
            <p>
              ...
              animi deserunt architecto. Earum delectus magnam dolorum
              accusantium saepe cumque facilis.
            </p>
          </div>
          <div>
            <h4> Visão</h4>
            <p>
              ...
              dolorem qui tempore corporis dolor veritatis nobis repellendus
              vel, iste mollitia facilis? Ab laborum sapiente nostrum excepturi!
